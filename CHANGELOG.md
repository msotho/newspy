...
## [2.2.24](https://github.com/msotho/newspy/compare/v2.2.23...v2.2.24) (2026-05-20)


### Bug Fixes

* add python 3.14 support ([5fa1475](https://github.com/msotho/newspy/commit/5fa147552924a5132735c1646a46b5be3bf8e30b))
* add python 3.14 support ([#401](https://github.com/msotho/newspy/issues/401)) ([52ac22d](https://github.com/msotho/newspy/commit/52ac22dfd2ca787c16149338119c7298a0ab4dc2))
* apply urllib3 updates which have security patches ([987c5e7](https://github.com/msotho/newspy/commit/987c5e7a9780234cb463e407973168ccc570aadb))
* **client:** add error handling for conflicting country and sources attributes ([b700671](https://github.com/msotho/newspy/commit/b700671f7a75dcb87b5f4d02d01026f71a569e34))
* **client:** allow configurable User-Agent via environment variable ([08bcb34](https://github.com/msotho/newspy/commit/08bcb34fb1a3558a70d8227d82ddcab98501ff84))
* **client:** allow configurable User-Agent via environment variable ([#397](https://github.com/msotho/newspy/issues/397)) ([e9281b3](https://github.com/msotho/newspy/commit/e9281b3a016e9c2d790a376281f51ef01d6c568f))
* **client:** enhance response handling in get_articles for string and None types ([a0d0994](https://github.com/msotho/newspy/commit/a0d0994565b752686aefbc1104793f262d963a82))
* **client:** improve error handling in get_articles and support additional XML content types ([74bcb00](https://github.com/msotho/newspy/commit/74bcb00958704279a119c82acd5686393313e127))
* **client:** remove Content-Type header from RSS feed requests ([b75aaec](https://github.com/msotho/newspy/commit/b75aaec9f59506d4e6ef7f947aad7adca06fea4c))
* **client:** remove Content-Type header from RSS feed requests ([1d6cb4e](https://github.com/msotho/newspy/commit/1d6cb4e9ba97ab3e87cc0e6f8b3576541c969c32))
* **client:** set User-Agent header for HTTP requests in client ([cd927c7](https://github.com/msotho/newspy/commit/cd927c77052b35dfefea93dd8a4573a3bff47274))
* **client:** set User-Agent header for HTTP requests in client ([#395](https://github.com/msotho/newspy/issues/395)) ([e390223](https://github.com/msotho/newspy/commit/e3902238f3afc01f4da88b7e3df088423dd17da6))
* **client:** use default User-Agent constant for HTTP requests ([9ad3c25](https://github.com/msotho/newspy/commit/9ad3c2504ab69c55633631cbf80629857421c09b))
* close files to prevent leaks ([3b0a57d](https://github.com/msotho/newspy/commit/3b0a57d478b1a346e46975b0ae0599c37ac5a7eb))
* **deps:** bump to latest ([d18391c](https://github.com/msotho/newspy/commit/d18391c28bfae345f45ef73be89a05a4a0a9f13d))
* **deps:** bump to latest ([c1e3a58](https://github.com/msotho/newspy/commit/c1e3a58ce0b57384ee208b0d4e1557b2c4697e9b))
* **deps:** bump to latest versions ([8951d1c](https://github.com/msotho/newspy/commit/8951d1c7e851b7be9b064e211787bbc37424b76b))
* **deps:** update aiohttp to 3.13.5, pygments to 2.20.0, python-discovery to 1.2.1, and tomli to 2.4.1 ([3d95c85](https://github.com/msotho/newspy/commit/3d95c85a1495457adba2be2e9c99bbe932dd1a63))
* **deps:** update package versions in poetry.lock ([033061e](https://github.com/msotho/newspy/commit/033061e85cbe45a1dfb1633d274fb19bcd8f7214))
* **deps:** update poetry.lock to bump package versions ([553f9e2](https://github.com/msotho/newspy/commit/553f9e211015661d6b0f6f800248370ed604670d))
* **deps:** update poetry.lock to bump package versions ([#357](https://github.com/msotho/newspy/issues/357)) ([da95377](https://github.com/msotho/newspy/commit/da95377417a9a60ce5ec6fb888fbea7a09f244db))
* **exceptions:** use CaseInsensitiveDict for headers in custom exception ([3265623](https://github.com/msotho/newspy/commit/3265623ced5bce5a2b4fd3803dc435b86d2815e5))
* explicit str return ([8e435cf](https://github.com/msotho/newspy/commit/8e435cfbfe0d2ece3688ca993d388beb87ab093e))
* **http_client:** update error message to use request.url instead of request.path_url ([e2fc3aa](https://github.com/msotho/newspy/commit/e2fc3aab20ea3a9e54a6f5a4869a6112ba4f59cb))
* release off the release branch ([35cf7ff](https://github.com/msotho/newspy/commit/35cf7ff08503fcf1ec68b970fd0b4c2a5642507b))
* release off the release branch ([#264](https://github.com/msotho/newspy/issues/264)) ([2f268c5](https://github.com/msotho/newspy/commit/2f268c52f0fa7ed08390a06bf46eeda912590e15))
* release workflow ([#458](https://github.com/msotho/newspy/issues/458)) ([879c8a5](https://github.com/msotho/newspy/commit/879c8a53c69082560987d9676eaa3ba7d6952dcd))
* **tests:** add type ignore for invalid file path in get_sources tests ([2bdc273](https://github.com/msotho/newspy/commit/2bdc27391336efc53926bfd79469cf84dbe8e0d8))
* **tests:** add type ignore for invalid file path in get_sources tests ([#394](https://github.com/msotho/newspy/issues/394)) ([9f71d92](https://github.com/msotho/newspy/commit/9f71d92737c62b5e8f8bba03bba289fa4e480b14))
* use sorted() instead of sort() in test assertion to avoid comparing None == None ([4d03b35](https://github.com/msotho/newspy/commit/4d03b357f176151948dcc7f22aa2828c5ed6a5bd))
* **workflow:** add fetch-depth and token to allow version update ([4cb88ec](https://github.com/msotho/newspy/commit/4cb88ecc96debd3c9ae5f3f413192868ecb3c2ee))
* **workflow:** do not modify and commit the toml version, publish wit… ([#272](https://github.com/msotho/newspy/issues/272)) ([58caccf](https://github.com/msotho/newspy/commit/58caccf45689e57ab5dca3b666416f022834a6ce))
* **workflow:** do not modify and commit the toml version, publish with the version ([1655aeb](https://github.com/msotho/newspy/commit/1655aeb0eeca161bd7d8e4a78685f03c80ae33ec))
* **workflow:** revert release workflow. bump up version before build … ([#274](https://github.com/msotho/newspy/issues/274)) ([f1796f5](https://github.com/msotho/newspy/commit/f1796f55cfed63e129511e51b62c0ac13bce1315))
* **workflow:** revert release workflow. bump up version before build and publish step ([24aa53f](https://github.com/msotho/newspy/commit/24aa53f224c3fbf17f604fc052e1519532c8d150))
* **workflow:** specify the release branch on the release workflow ([d664c8f](https://github.com/msotho/newspy/commit/d664c8fd95d51e0fbbbfb209ca93bf4f47e54e8e))
* **workflow:** specify the release branch on the release workflow ([#271](https://github.com/msotho/newspy/issues/271)) ([48467a7](https://github.com/msotho/newspy/commit/48467a79d2c76e10b8c408540d47a9fcd87c8dcd))
